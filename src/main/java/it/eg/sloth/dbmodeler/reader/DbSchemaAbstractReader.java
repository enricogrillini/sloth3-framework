...
public abstract class DbSchemaAbstractReader implements DbSchemaReader {
    ...
    public DbSchemaAbstractReader(DataBaseType dataBaseType, String jdbcUrl, String username, String password, String owner) {
    ...
    @Override
    public void addSequences(Schema schema) throws SQLException, IOException {
        for (Sequence dataRow : sequencesData()) {
            schema.addSequence(dataRow);
        }
    }
//
//    @Override
